...
namespace MessagePackTests
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            byte[] bytes = EngineSerializer.Instance.Serializer.Serialize(myShape); // 173 bytes
        ...
        private static MyShape CreateShape()
        {
            MyShape shape = new(
                ...
                [
                    ...
                    new KomodoDragon(Guid.NewGuid(), new Vector2(64f, 256f), 0f, 0.1f, Color.FromArgb(50, 69, 42, 37), Rectangle.Empty, false, 0.5f)
                ]);
